import type { ClientQueueOrderDto, ClientReleaseLogDto } from '../../api/client/queue';

export const INITIAL_CLIENT_QUEUE_ORDER_DTOS: ClientQueueOrderDto[] = [
    {
      id: 'ORD-102456',
      name: '理财方案 A 套餐 (已购)',
      amount: 10000.00,
...
export const INITIAL_CLIENT_RELEASE_LOG_DTOS: ClientReleaseLogDto[] = [
    {
      id: 'LOG-001',
