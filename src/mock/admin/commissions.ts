import type { AdminCommissionDto, AdminOverflowLogDto } from '../../api/admin/commissions';

export const INITIAL_ADMIN_COMMISSION_DTOS: AdminCommissionDto[] = [
...
export const INITIAL_ADMIN_OVERFLOW_LOG_DTOS: AdminOverflowLogDto[] = [
