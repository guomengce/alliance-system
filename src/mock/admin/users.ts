import type { TeamMember } from '../../features/admin/users/types';

const TEAM_MEMBER_SEEDS: TeamMember[] = [
...
export const getInitialTeamMembers = (): TeamMember[] => (
  TEAM_MEMBER_SEEDS.map((member) => ({ ...member }))
);
