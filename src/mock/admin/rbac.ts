import type { AdminAccountDto, AdminRoleDto, PermissionDefinitionDto } from '../../api/admin/rbac';

export const INITIAL_PERMISSION_DEFINITION_DTOS: PermissionDefinitionDto[] = [
...
export const INITIAL_ROLE_PERMISSION_DTOS: AdminRoleDto[] = [
  {
    roleName: '超级系统管理员',
...
export const INITIAL_ADMIN_ACCOUNT_DTOS: AdminAccountDto[] = [
  {
    id: 'ACC-001',
