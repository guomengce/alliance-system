  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <span className="text-xs font-black bg-[#cfbcff]/15 text-[#cfbcff] px-2 py-0.5 rounded border border-[#cfbcff]/10">
          {member.level} MEMBER
        </span>
      </div>
  ...
  return (
    <div className={`space-y-2 ${index > 0 ? 'pt-4' : ''}`}>
      <div className="flex justify-between items-center">
        ...
        <span className="text-xs font-semibold text-[#cfbcff] bg-[#cfbcff]/5 px-2 py-0.5 rounded border border-[#cfbcff]/15">
          {member.level}级 (直推)
        </span>
      </div>
