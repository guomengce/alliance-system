...
export default function Banner({ onNavigateToRoute }: BannerProps) {
  return (
    <div className="relative w-full h-[260px] rounded-2xl overflow-hidden glass-card group">
      <div className="absolute inset-0 bg-gradient-to-r from-[#6750a4] via-[#4d4465]/60 to-transparent z-10" />
      <img
      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-10 md:px-12 max-w-2xl">
        ...
        <h2 className="text-2xl md:text-3.5xl font-extrabold text-white leading-tight mb-2" style={{ fontWeight: 800 }}>
          同盟系统 2.0 正式上线
        </h2>
        ...
        <Button
          className="alliance-antd-button-primary w-fit"
