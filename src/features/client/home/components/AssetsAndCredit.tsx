...
export default function AssetsAndCredit({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <AntdCard className="alliance-antd-glass-card">
        <div className="p-6 md:p-8 flex flex-col justify-between min-h-[220px] relative overflow-hidden">
          <div className="absolute -top-12 -right-12 w-48 h-48 bg-[#cfbcff]/5 blur-[80px] rounded-full" />
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h3 className="text-4xl text-[#cfbcff] tracking-tight mt-3" style={{ fontWeight: 800 }}>
                {usdtBalance.toLocaleString('zh-CN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}{' '}
                <span className="text-lg font-normal text-[#cbc4d2]">USDT</span>
              </h3>
            </div>
          </div>
      ...
      <AntdCard className="alliance-antd-glass-card">
        <div className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 justify-between">
          <div className="relative w-36 h-36 flex items-center justify-center flex-shrink-0">
            <svg className="w-full h-full transform -rotate-90" viewBox="0 0 144 144" width="144" height="144">
              <circle className="text-[#36343a]" cx="72" cy="72" fill="transparent" r={radius} stroke="currentColor" strokeWidth="8" />
              <circle
                cx="72"
                cy="72"
                fill="transparent"
          ...
          <div className="flex-1 w-full space-y-4">
            ...
            <Button className="alliance-antd-button-muted" onClick={onRaiseCredit}>
              提升额度
            </Button>
          </div>
        </div>
