  ...
  return (
    <div className="lg:col-span-4 glass-card rounded-2xl p-6 flex flex-col gap-4">
      <div className="flex items-center justify-between border-b border-white/5 pb-2">
        ...
        <span className="text-xs text-[#cbc4d2]/60 font-medium">高级交易权限</span>
      </div>
        ...
        <div className="flex items-center justify-between p-3 rounded-xl bg-[#211f24] border border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#cbc4d2]/60">手机与邮箱信息</p>
            </div>
          </div>
          <span className="text-xs font-extrabold text-[#e7c365] bg-[#e7c365]/10 px-2 py-0.5 rounded border border-[#e7c365]/20">
            已认证
          </span>
        </div>
        ...
        <div className="flex items-center justify-between p-3 rounded-xl bg-[#211f24] border border-[#cfbcff]/25">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#cbc4d2]/60">身份识别 / 面部扫描</p>
            </div>
          </div>
          <span className="text-xs font-extrabold text-[#cfbcff] bg-[#cfbcff]/10 px-2 py-0.5 rounded border border-[#cfbcff]/20">
            审核中
          </span>
        </div>
      </div>
