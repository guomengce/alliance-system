  ...
  return (
    <tr className="border-b border-white/5 last:border-none">
      <td className="py-3 text-sm flex items-center gap-2">
        <div className="w-7 h-7 rounded-full bg-[#36343a] flex items-center justify-center text-[10px] font-extrabold text-[#cfbcff]">{activity.id}</div>
    ...
    <div className="flex justify-between items-center bg-white/[0.01] p-3 rounded-lg border border-white/5">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-[#cbc4d2]/60 font-mono mt-0.5">{activity.time}</p>
        </div>
      </div>
