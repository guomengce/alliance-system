          ...
          <AntdCard key={member.uid} className="alliance-antd-finance-mobile-card">
            <div className="flex justify-between items-center border-b border-white/5 pb-2.5">
              <div>
                ...
                <div className="text-[10px] text-[#cbc4d2]/40 font-mono mt-0.5">UID: {member.uid}</div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-y-3 gap-x-4 font-mono text-[11px] pb-1">
              <div>
                <span className="text-[#cbc4d2]/40 text-[9px] font-sans block leading-none mb-1">{WALLETS_TEXT.usdt}</span>
              ...
              <div>
                <span className="text-[#cbc4d2]/40 text-[9px] font-sans block leading-none mb-1">{WALLETS_TEXT.frozen}</span>
              ...
              <div>
                <span className="text-[#cbc4d2]/40 text-[9px] font-sans block leading-none mb-1">{WALLETS_TEXT.troo}</span>
              ...
              <div>
                <span className="text-[#cbc4d2]/40 text-[9px] font-sans block leading-none mb-1">{WALLETS_TEXT.pending}</span>
              ...
              <div className="col-span-2 pt-2 border-t border-white/5">
                <span className="text-[#cbc4d2]/40 text-[9px] font-sans block leading-none mb-1">{WALLETS_TEXT.total}</span>
