import type { SettleLog, SettlementItem } from './types';

export const INITIAL_SETTLEMENT_LOGS: SettleLog[] = [
...
export const INITIAL_SETTLEMENT_TRANSACTIONS: SettlementItem[] = [
