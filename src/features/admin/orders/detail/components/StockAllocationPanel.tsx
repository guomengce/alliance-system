...
export default function StockAllocationPanel({ selectedOrder }: StockAllocationPanelProps) {
  return (
          ...
          <div className="divide-y divide-white/5 text-[11px] pt-1">
            ...
            <div className="flex justify-between py-2">
              ...
              <span className="text-[#cfbcff] font-extrabold">
                {selectedOrder.stockConversion.giftedStocks > 0 ? `+${selectedOrder.stockConversion.giftedStocks.toLocaleString()} 股` : '无额外赠送'}
              </span>
            </div>
          </div>
        </div>
