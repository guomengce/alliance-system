...
export default function AdminRbacView() {
  // Pre-defined permission inventory
  ...
  const [editStatus, setEditStatus] = useState<'active' | 'suspended' | 'isolated'>('active');
  ...
  const handleCreateRole = (e: React.FormEvent) => {
    ...
    const cleanCode = newRoleCode.toUpperCase().replace(/\s+/g, '_');
